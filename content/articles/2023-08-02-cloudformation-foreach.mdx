...
It's great to see AWS taking input from end users into account when developing new
features. The time taken from the feature being marked as approved and it being
released for general availability was around a month. It's always interesting to
get a little insight to how AWS propose, plan and deliver features.
