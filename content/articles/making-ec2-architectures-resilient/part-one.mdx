...
author: 'Alex Kearns'
date: '2023-10-01'
title: 'Making EC2 architectures resilient: part one'
description:
  'Part one of a series of articles about making EC2 architectures more
  resilient.'
---
...
instance. As we go through this workshop, I hope you'll realise that when done
properly it can add significant peace of mind and actually _remove_ some of the
maintenance overhead, even if it does make the overall solution more complex.
