...
export const meta = {
  ...
  description: 'So, you want to allow developers to create IAM roles without compromising security? You\'re in the right place! Permissions boundaries are very much the answer.',
}
