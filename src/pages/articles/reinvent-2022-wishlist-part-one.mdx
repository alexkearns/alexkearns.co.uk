...
import lambdaOutboundNetworkAccessImage from '@/images/articles/reinvent-2022-wishlist-part-one/lambda-outbound-network-access.png'
import stepFunctionVizImage from '@/images/articles/reinvent-2022-wishlist-part-one/step-function-viz.png'
...
<Image src={lambdaOutboundNetworkAccessImage} alt="" />

## Executing a Step Functions workflow task as an assumed role

The next item (and the final one actually) on my wishlist for this entry in the series are centred around AWS Step Functions.
...
<Image src={stepFunctionVizImage} alt="" />
